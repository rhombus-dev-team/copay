<img src="https://raw.githubusercontent.com/rhombus/copay/master/resources/rhombus-copay/android/app-store/feature-graphic-1024.png" alt="Rhombus Copay">

[![Build Status](https://secure.travis-ci.org/rhombus/copay.svg)](http://travis-ci.org/rhombus/copay)

Rhombus Copay is a secure rhombus wallet platform for both desktop and mobile devices. Copay uses [Bitcore Wallet Service](https://github.com/rhombus/bitcore-wallet-service) (BWS) for peer synchronization and network interfacing.
...
- Support for Rhombus testnet wallets
...
> **Note:** This method should only be used for development purposes. When running Copay in a normal browser environment, browser extensions and other malicious code might have access to internal data and private keys. For production use, see the latest official [releases](https://github.com/rhombus/copay/releases/).

Clone the repo and open the directory:

```sh
git clone https://github.com/rhombus/copay.git
cd copay
```
...
Information about backup and recovery procedures is available at: https://github.com/rhombus/copay/blob/master/backupRecovery.md
...
Copay depends on [Bitcore Wallet Service](https://github.com/rhombus/bitcore-wallet-service) (BWS) for blockchain information, networking and Copayer synchronization. A BWS instance can be setup and operational within minutes or you can use a public instance like `https://bws.rhombus.io`. Switching between BWS instances is very simple and can be done with a click from within Copay. BWS also allows Copay to interoperate with other wallets like [Bitcore Wallet CLI](https://github.com/rhombus/bitcore-wallet).
...
Copay is released under the MIT License. Please refer to the [LICENSE](https://github.com/rhombus/copay/blob/master/LICENSE) file that accompanies this project for more information including complete terms and conditions.
